  ...
  return (
    <main className="shell">
      <header className="topbar">
        <div>
          <h1 className="brand">Firm</h1>
          <p className="sub">
            Owner control plane for opportunity → proposal → delivery → settled cash.
            Agents are internal workers under one verified business identity.
          </p>
        </div>
